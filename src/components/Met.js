...
{/* Oxbow and downloadables */}
      ...
      {/* <div className="inline-block"> */}
        ...
        <div className="px-3">
          ...
          <p className="text-lg">You can search the <a href="https://www.metmuseum.org/art/the-collection">Met's collection</a> by title, keyword, artist, geographic region, historical period, material, and more, or you can look through curated collections available on the museum's site. <a href="https://www.metmuseum.org/art/collection/search?showOnly=highlights%7CwithImage&pageSize=0&sortBy=Relevance&sortOrder=asc&searchField=All">Highlights of the collection</a> have their own page, as do <a href="https://www.metmuseum.org/art/collection/search?showOnly=withImage%7CopenAccess&pageSize=0&sortBy=Relevance&sortOrder=asc&searchField=All">Open Access works</a> available for free download. Click on any of the works and you can learn much more about each piece in depth.</p>
        
          <h2>3D Printing Models</h2>
          <p className="text-lg">Want a copy of a sculptural work from the Met's collection? If you have access to a 3D printer, you can download files for free and print your own copy! In fact, the Met encourages visitors to create their own files for 3D models by photographing works in the public domain. You can download files from the Met's <a href="https://www.thingiverse.com/met/designs">thingiverse page</a> and search for more files created by visitors online.</p>
        </div>
...
{/* VanGogh Sky bannner */}
      <img 
        src={SkyDetail} 
        alt="Detail from Van Gogh's Wheat Fields with Cypresses" 
        className="my-0"/>
...
{/* Tunic banner */}
      <img 
        src={TunicDetail} 
        alt="Detail from a Peruvian Tunic, Met 1987.394.706" 
        className="my-0"/>
